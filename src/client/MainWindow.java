...
public class MainWindow extends javax.swing.JFrame {
     ...
     */
    public MainWindow() {
        //liitet��n ProcessClient k�ytt�liittym��n
    	try {
    ...
    private void initComponents() {
        ...
        startSiloLoad = new javax.swing.JButton();
        ...
        siloLoadLabel.setIcon(conveyor);
        ...
        procLoadLabel2.setIcon(conveyor);
    ...
    private void signInActionPerformed(java.awt.event.ActionEvent evt) {
        // Nimi hyv�ksyt��n jos palvelin sanoo true
    	String name = userName.getText();
    	if (pc.login(name)) pc.setName(name);
    	
        JButton[] buttonList = new JButton[]{startSiloLoad, startProcLoad1, startProcLoad2,
     ...
     */
    private void setButton(JButton button, boolean b){
    	button.setEnabled(b);
    }
     ...
     * @param b true, jos laite on k�yt�ss�, muuten false
     */
    ...
    /**
     * Asettaa k�ytt�liittym�elementille tekstin
     * @param label k�ytt�liittym�elementti
    ...
    /**
     * P�ivitt�� painikkeet ja statustekstit palvelimelta saadun tilaolion mukaisesti
     */
    private void update(){
    	ProcessState state = pc.getState();
    	
    	if(state.isSiloLoader()){
    		siloLoadLabel.setIcon(conveyorRunning);
		...
		silo1Status.setText((Integer.toString(state.getSilo1Amount())));
		if(state.getSilo1Amount() == 0) silo1Label.setIcon(silo);
		else silo1Label.setIcon(siloLoaded);
		if(state.isSilo1()){
		...
		silo2Status.setText((Integer.toString(state.getSilo2Amount())));
		if(state.getSilo2Amount() == 0) silo2Label.setIcon(silo);
		else {
			silo2Label.setIcon(siloLoaded);
		}
		if(state.isSilo2()){
		...
		silo3Status.setText((Integer.toString(state.getSilo3Amount())));
		if(state.getSilo3Amount() == 0) silo3Label.setIcon(silo);
		else silo3Label.setIcon(siloLoaded);
		if(state.isSilo3()){
		...
		silo4Status.setText((Integer.toString(state.getSilo4Amount())));
		if(state.getSilo4Amount() == 0) silo4Label.setIcon(silo);
		else silo4Label.setIcon(siloLoaded);
		if(state.isSilo4()){
    	...
    	if(state.isProcLoader2()){
      	...
      	setText(proc1User, state.getProc1User());
    	if(state.isProc1Reserved()) setButton(reserveProc1, false);
    	else setButton(reserveProc1, true);
    	if(state.isProc1Running()){
            proc1Label.setIcon(processorRunning);
    		setStatus(proc1Status, true);
			setButton(startProc1, false);
    	} else {
    		if(state.isProc1Empty()) proc1Label.setIcon(processor);
    		else proc1Label.setIcon(processorLoaded); 
    		setStatus(proc1Status, false);
    		if(state.getProc1User().equals(pc.getName())) setButton(startProc1, true);
    	}
    	
      	setText(proc2User, state.getProc2User());
    	if(state.isProc2Reserved()) setButton(reserveProc2, false);
    	else setButton(reserveProc2, true);
    	if(state.isProc2Running()){
            proc2Label.setIcon(processorRunning); 
    		setStatus(proc2Status, true);
			setButton(startProc2, false);
    	} else {
    		if(state.isProc2Empty()) proc2Label.setIcon(processor);
    		else proc2Label.setIcon(processorLoaded); 
    		setStatus(proc2Status, false);
    		if(state.getProc2User().equals(pc.getName())) setButton(startProc2, true);
    	}
    	
      	setText(proc3User, state.getProc3User());
    	if(state.isProc3Reserved()) setButton(reserveProc3, false);
    	else setButton(reserveProc3, true);
    	if(state.isProc3Running()){
    		proc3Label.setIcon(processorRunning);
    		setStatus(proc3Status, true);
			setButton(startProc3, false);
    	} else {
    		if(state.isProc3Empty()) proc3Label.setIcon(processor);
    		else proc3Label.setIcon(processorLoaded); 
    		setStatus(proc3Status, false);
    		if(state.getProc3User().equals(pc.getName())) setButton(startProc3, true);
    	}
    	
    	
    	if(state.isPump1()){
    		pump1Label.setIcon(pumpRunning);
    	...
    	if(state.isPump2()){
    		pump2Label.setIcon(pumpRunning);
    	...
    	tank1Status.setText(Integer.toString(state.getTank1Amount()));
    	if(state.getTank1Amount() == 0) tank1Label.setIcon(tank);
    	else tank1Label.setIcon(tankLoaded);
    	if(state.isTank1()) setButton(reserveTank1, false);
    	else setButton(reserveTank1, true);
    	
    	tank2Status.setText(Integer.toString(state.getTank2Amount()));
    	if(state.getTank2Amount() == 0) tank2Label.setIcon(tank);
    	else tank2Label.setIcon(tankLoaded);
    	if(state.isTank2())	setButton(reserveTank2, false);
    	else setButton(reserveTank2, true);
    	
    	tank3Status.setText(Integer.toString(state.getTank3Amount()));
    	if(state.getTank3Amount() == 0) tank3Label.setIcon(tank);
    	else tank3Label.setIcon(tankLoaded);
    	if(state.isTank3()) setButton(reserveTank3, false);
    	else setButton(reserveTank3, true);
    	
    	tank4Status.setText(Integer.toString(state.getTank4Amount()));
    	if(state.getTank4Amount() == 0) tank4Label.setIcon(tank);
    	else tank4Label.setIcon(tankLoaded);
    	if(state.isTank4()) setButton(reserveTank4, false);
    	else setButton(reserveTank4, true);
    	
    	tank5Status.setText(Integer.toString(state.getTank5Amount()));
    	if(state.getTank5Amount() == 0) tank5Label.setIcon(tank);
    	else tank5Label.setIcon(tankLoaded);
    	if(state.isTank5()) setButton(reserveTank5, false);
    	else setButton(reserveTank5, true);
    	
    	tank6Status.setText(Integer.toString(state.getTank6Amount()));
    	if(state.getTank6Amount() == 0) tank6Label.setIcon(tank);
    	else tank6Label.setIcon(tankLoaded);
    	if(state.isTank6()) setButton(reserveTank6, false);
    	else setButton(reserveTank6, true);
    	
    	tank7Status.setText(Integer.toString(state.getTank7Amount()));
    	if(state.getTank7Amount() == 0) tank7Label.setIcon(tank);
    	else tank7Label.setIcon(tankLoaded);
    	if(state.isTank7()) setButton(reserveTank7, false);
    	else setButton(reserveTank7, true);
    	
    	tank8Status.setText(Integer.toString(state.getTank8Amount()));
    	if(state.getTank8Amount() == 0) tank8Label.setIcon(tank);
    	else tank8Label.setIcon(tankLoaded);
    	if(state.isTank8()) setButton(reserveTank8, false);
    	else setButton(reserveTank8, true);
    	
    	tank9Status.setText(Integer.toString(state.getTank9Amount()));
    	if(state.getTank9Amount() == 0) tank9Label.setIcon(tank);
    	else tank9Label.setIcon(tankLoaded);
    	if(state.isTank9()) setButton(reserveTank9, false);
    	else setButton(reserveTank9, true);
    	
    	tank10Status.setText(Integer.toString(state.getTank10Amount()));
    	if(state.getTank10Amount() == 0) tank10Label.setIcon(tank);
    	else tank10Label.setIcon(tankLoaded);
    	if(state.isTank10()) setButton(reserveTank10, false);
    	else setButton(reserveTank10, true);
    	
    	
    	if(state.isBottlePump1()){
    		bpump1Label.setIcon(pumpRunning);
    	...
    	if(state.isBottlePump2()){
    		bpump2Label.setIcon(pumpRunning);
    ...
    /**
     * Hakee palvelimelta viittauksen tilaolioon ja aloittaa s�ikeen, joka p�ivitt�� ikkunan tilan perusteella sekunnin v�lein.
     */
    ...
    //K�ytt�liittym��n liittyv� asiakas
    private ProcessClient pc;
   
    //K�ytt�liittym�n kuvat
    private ImageIcon processorLoaded;
    private ImageIcon processorRunning;
    private ImageIcon processor;
    private ImageIcon conveyor;
    private ImageIcon conveyorRunning;
    private ImageIcon silo;
    private ImageIcon siloLoaded;
    private ImageIcon tank;
    private ImageIcon tankLoaded;
    private ImageIcon pump;
    private ImageIcon pumpRunning;
    ...
    private javax.swing.JButton reserveProc1;
    private javax.swing.JButton reserveProc2;
    private javax.swing.JButton reserveProc3;
    private javax.swing.JButton reserveSilo1;
    private javax.swing.JButton reserveSilo2;
    private javax.swing.JButton reserveSilo3;
    private javax.swing.JButton reserveSilo4;
    private javax.swing.JButton reserveTank1;
    private javax.swing.JButton reserveTank10;
    private javax.swing.JButton reserveTank2;
    private javax.swing.JButton reserveTank3;
    private javax.swing.JButton reserveTank4;
    private javax.swing.JButton reserveTank5;
    private javax.swing.JButton reserveTank6;
    private javax.swing.JButton reserveTank7;
    private javax.swing.JButton reserveTank8;
    private javax.swing.JButton reserveTank9;
    ...
    private javax.swing.JButton startBpump1;
    private javax.swing.JButton startBpump2;
    private javax.swing.JButton startProc1;
    private javax.swing.JButton startProc2;
    private javax.swing.JButton startProc3;
    private javax.swing.JButton startProcLoad1;
    private javax.swing.JButton startProcLoad2;
    private javax.swing.JButton startPump1;
    private javax.swing.JButton startPump2;
    private javax.swing.JButton startSiloLoad;
